...
var numberOfFloorsBurjKhalifa = 160;
...
var japanPrefectures = ['Tokyo', 'Kyoto', 'Osaka', 'Sapporo', 'Yokohama'];
...
var india = ['Taj Mahal', 'Ganges River', 'Mahabodhi Temple'];
console.log(india);
...
var betterSnacks = snacks.slice(2, 6);
console.log(betterSnacks);
...
var comparison = "Racecar" === 'racecar';
var secondComparison = 'three' === 3;
...
/*16. As the general manager for the DevLeague Prep Beer Pong Team, your job is to select the starting players from the roster array. 
Create two variables, Ateam and Bteam and assign each an empty array. 
You will then assigned players that have an even number index position to the Ateam and odd number index position to the Bteam. 
Let the games begin! Console log the results.*/

var roster = ["Alex", "Laura", "Sami", "Jasmine", "Adam", "Dakota", "Jonathon", "Luther", "Kevin", "Vic"];
var Ateam = [];
var Bteam = [];

function gameTime (arr){
